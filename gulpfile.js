...
gulp.task('dist', function () {
	gulp.src('app/public/wp-content/themes/' + dravet + '/**')
		.pipe(gulp.dest('dist/themes/' + dravet))
});

gulp.task('copy-theme-dev', function () {
	gulp.src("src/theme/**")
		.pipe(gulp.dest('app/public/wp-content/themes/' + dravet));
});
...
gulp.task('login-style-dev', function () {
	return gulp.src('src/theme/inc/style/login.scss')
		...
		.pipe(sourcemaps.write('../' + dravet))
		.pipe(gulp.dest('app/public/wp-content/themes/' + dravet + '/inc/style'))
		.pipe(browserSync.stream({ match: '**/*.css' }));
});
...
gulp.task('login-style-prod', function () {
	return gulp.src('src/theme/inc/style/login.scss')
		...
		.pipe(gulp.dest('dist/themes/' + dravet + '/inc/style'))
});
...
gulp.task('header-scripts-dev', function () {
	return gulp.src(headerJS)
		...
		.pipe(gulp.dest('app/public/wp-content/themes/' + dravet + '/js'));
});
...
gulp.task('header-scripts-prod', function () {
	return gulp.src(headerJS)
		...
		.pipe(concat('header-bundle.js'))
		.pipe(uglify())
		.pipe(gulp.dest('dist/themes/' + dravet + '/js'));
});
...
gulp.task('copy-fonts-dev', () => {
	gulp.src('src/theme/fonts/**')
		.pipe(gulp.dest('app/public/wp-content/themes/' + dravet + '/fonts'))
});

gulp.task('copy-fonts-prod', () => {
	gulp.src('src/theme/fonts/**')
		.pipe(gulp.dest('dist/themes/' + dravet + '/fonts'))
});
/*********************
Images
*********************/
...
gulp.task('process-images', ['svg-icons'], function() {
    ...
    .pipe(gulp.dest('dist/themes/' + dravet + '/images'));
});

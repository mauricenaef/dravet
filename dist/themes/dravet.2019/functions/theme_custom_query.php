...
if ( ! function_exists( 'bulmastarter_custom_query' ) ) {
	function bulmastarter_custom_query($args = array())
	{
		...
		if ($post_class == '') {
			$bulmastarter_post_class = $post_type;
		} else {
			$bulmastarter_post_class = $post_class;
		}

		$output = '<div class="'.$bulmastarter_post_class.'">';

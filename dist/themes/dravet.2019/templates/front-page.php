...
<section class="section events-section cards-section">
    <div class="container">
        <h1 class="title is-size-6 is-bold">Zukünftige Veranstaltungen</h1>
        <div class="columns is-multiline">
            ...
            <div class="column is-4">
                <div class="card has-boxshadow">
                    <div class="card-image">
                        <figure class="image ">
                            <?php echo wp_get_attachment_image( 208, 'card-header', false, array( 'class' => 'hero' ) ); ?>
                        </figure>
                    </div>
                    <div class="card-content">
                        <div class="media-content">
            ...
            <div class="column is-4">
                <div class="card has-boxshadow">
                    <div class="card-image">
                        <figure class="image ">
                            <?php echo wp_get_attachment_image( 207, 'card-header', false, array( 'class' => 'hero' ) ); ?>
                        </figure>
                    </div>
                    <div class="card-content">
                        <div class="media-content">
            ...
            <div class="column is-4">
                <div class="card has-boxshadow">
                    <div class="card-image">
                        <figure class="image ">
                            <?php echo wp_get_attachment_image( 158, 'card-header', false, array( 'class' => 'hero' ) ); ?>
                        </figure>
                    </div>
                    <div class="card-content">
                        <div class="media-content">
